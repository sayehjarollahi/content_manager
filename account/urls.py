...
urlpatterns = [
    ...
    path('content/<int:content_id>/addLibrary/', content_view.add_to_library, name='add_library'),
    path('content/<int:content_id>/shareContent/', content_view.share_content, name='share_content'),
